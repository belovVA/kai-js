...
app.post("/api/books", function (req, res) {
    ...
    const book = {title: title, publisher: publisher, authors:authors, ownerName:ownerName,returnDate:returnDate  };
...
app.put("/api/books", function(req, res){
  ...
  app.listen(3000, function(){
   ...
   app.put("/api/books/:id", function (req, res) {
    ...
    const { title, publisher, authors, ownerName, returnDate } = req.body;
    const book = books[index];
